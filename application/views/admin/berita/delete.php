<button class="btn btn-danger btn" data-toggle="modal" data-target="#myModal<?php echo $berita->id_berita ?>" title="Delete User">
<i class="fa fa-trash-o"></i> Hapus Berita</button>
